...
const rows = [
  ...
  createData('Coffee', ['Coffee,', ' ', 'Arabica coffee,', ' ', 'Robusta coffee'], ['Coffee spp.,', ' ', 'Coffea arabica,', ' ', 'Coffea canephora'], 'Africa', 'Brown', 'View color-swatches'),
  createData('Tea', 'Camellia sinensis', ['Black tea,', ' ', 'White tea,', ' ', 'Green tea'], 'Asia', ['Pale green,', ' ', 'or Yellow'], 'View color-swatches'),
